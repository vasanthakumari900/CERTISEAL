        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-semibold mb-2">
              ...
              Employer & HR Verification Hub — CERTX Platform
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white">Employer Verification Dashboard</h1>
            ...
            <table className="w-full text-xs text-left">
              ...
              <tbody className="divide-y divide-slate-800">
                {recentVerifications.map((row) => {
                  ...
                  if (row.result === 'REVOKED') badgeStyle = 'bg-rose-500/20 text-rose-400 border-rose-500/40';
