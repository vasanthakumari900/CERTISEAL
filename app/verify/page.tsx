...
export default function VerifyPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (data.verificationResult) {
        // Redirect to verification result page with uploaded comparison state
  ...
  // Demo Upload Simulator for Judge Presentation
    ...
    <div className="max-w-4xl mx-auto space-y-8 py-4">
      ...
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-semibold">
          ...
          Triple-Mode Certificate Verification Engine
        </div>
      ...
      <div className="bg-navy-900/60 rounded-2xl border border-slate-800 p-6 sm:p-8">
        {/* Method B: Certificate ID Lookup */}
        {activeTab === 'ID' && (
          ...
          <div className="space-y-6">
            ...
            {isProcessingUpload && (
              <div className="p-4 rounded-xl bg-blue-950/60 border border-blue-800 text-blue-300 flex items-center gap-3 text-xs">
                ...
                <span>Processing OCR field extraction & running 12-step cryptographic verification...</span>
              </div>
            )}
            ...
            {/* Quick Demo Tamper Simulator button */}
